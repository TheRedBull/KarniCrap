...
function KarniCrap_InitializeUI()
	...
	KarniCrap_Cloth_CBTidesprayLinen_Never:SetChecked(KarniCrapConfig.Cloth_TidesprayLinen_Never)
	KarniCrap_Cloth_CBShroudedCloth_Never:SetChecked(KarniCrapConfig.Cloth_ShroudedCloth_Never)
